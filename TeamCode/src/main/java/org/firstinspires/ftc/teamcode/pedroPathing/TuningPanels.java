 ...
 */
@Configurable
@TeleOp(name = "Tuning Panelke", group = "Pedro Pathing")
public class TuningPanels extends SelectableOpMode {
    public static Follower follower;
//trans pidf: p = 0.055, i = 0, f = 0.02, d =0.04
    @IgnoreConfigurable
    ...
    public TuningPanels() {
        super("Select a Tuning OpMode", s -> {
            s.folder("Localization", l -> {
                l.add("Localization Test", LocalizationTestP::new);
                l.add("Forward Tuner", ForwardTunerP::new);
                l.add("Lateral Tuner", LateralTunerP::new);
                l.add("Turn Tuner", TurnTunerP::new);
            });
            s.folder("Automatic", a -> {
                a.add("Forward Velocity Tuner", ForwardVelocityTunerP::new);
                a.add("Lateral Velocity Tuner", LateralVelocityTunerP::new);
                a.add("Forward Zero Power Acceleration Tuner", ForwardZeroPowerAccelerationTunerP::new);
                a.add("Lateral Zero Power Acceleration Tuner", LateralZeroPowerAccelerationTunerP::new);
            });
            s.folder("Manual", p -> {
                p.add("Translational Tuner", TranslationalTunerP::new);
                p.add("Heading Tuner", HeadingTunerP::new);
                p.add("Drive Tuner", DriveTunerP::new);
                p.add("Line Tuner", LineP::new);
                p.add("Centripetal Tuner", CentripetalTunerP::new);
            });
            s.folder("Tests", p -> {
                p.add("Line", LineP::new);
                p.add("Triangle", TriangleP::new);
                p.add("Circle", CircleP::new);
            });
        });
    }
 ...
 */
class LocalizationTestP extends OpMode {
    @Override
    public void init() {
 ...
 * @version 1.0, 5/6/2024
 */
class ForwardTunerP extends OpMode {
 ...
 */
class LateralTunerP extends OpMode {
    public static double DISTANCE = 48;
 ...
 * @version 1.0, 5/6/2024
 */
class TurnTunerP extends OpMode {
 ...
 */
class ForwardVelocityTunerP extends OpMode {
 ...
 * @version 1.0, 3/13/2024
 */
class LateralVelocityTunerP extends OpMode {
    private final ArrayList<Double> velocities = new ArrayList<>();
 ...
 * @version 1.0, 3/13/2024
 */
class ForwardZeroPowerAccelerationTunerP extends OpMode {
 ...
 * @version 1.0, 3/13/2024
 */
class LateralZeroPowerAccelerationTunerP extends OpMode {
    private final ArrayList<Double> accelerations = new ArrayList<>();
    public static double VELOCITY = 30;
    private double previousVelocity;
    private long previousTimeNano;
 ...
 */
class TranslationalTunerP extends OpMode {
 ...
 * @version 1.0, 3/12/2024
 */
class HeadingTunerP extends OpMode {
    public static double DISTANCE = 40;
    private boolean forward = true;
 ...
 * @version 1.0, 3/12/2024
 */
class DriveTunerP extends OpMode {
    public static double DISTANCE = 40;
    private boolean forward = true;
 ...
 * @version 1.0, 3/13/2024
 */
class CentripetalTunerP extends OpMode {
 ...
 */
class TriangleP extends OpMode {
