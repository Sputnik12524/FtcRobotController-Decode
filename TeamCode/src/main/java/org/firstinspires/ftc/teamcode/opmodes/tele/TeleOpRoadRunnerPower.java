...
@TeleOp(name = "TeleOpRR Shooter - Power", group = "0")
public class TeleOpRoadRunnerPower extends LinearOpMode {
...
//Никита сказал, что хочет телеоп константс класс
//вова недоволен телеопом
