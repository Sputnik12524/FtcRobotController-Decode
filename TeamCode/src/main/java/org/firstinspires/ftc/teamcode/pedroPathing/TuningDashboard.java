...
//
//        telemetryM = FtcDashboard.getInstance().getTelemetry();
//    }
//
//    @Override
...
//        telemetryM.addData("total heading:" , follower.getTotalHeading());
//        telemetryM.update();
//
//        draw();
//    }
...
//        follower.update();
//
//        telemetryM.addData("Distance Moved: " , (follower.getPose().getX() - 72));
...
//        telemetryM.addData("Multiplier: " , (DISTANCE / ((follower.getPose().getX() - 72) / follower.getPoseTracker().getLocalizer().getForwardMultiplier())));
//        telemetryM.update();
//
//        draw();
//    }
...
//        follower.update();
//
//        telemetryM.addData("Distance Moved: " , (follower.getPose().getY() - 72));
...
//        telemetryM.addData("Multiplier: " , (DISTANCE / ((follower.getPose().getY() - 72) / follower.getPoseTracker().getLocalizer().getLateralMultiplier())));
//        telemetryM.update();
//
//        draw();
//    }
...
//        follower.update();
//
//        telemetryM.addData("Total Angle: " , follower.getTotalHeading());
...
//        telemetryM.addData("Multiplier: " , (ANGLE / (follower.getTotalHeading() / follower.getPoseTracker().getLocalizer().getTurningMultiplier())));
//        telemetryM.update();
//
//        draw();
//    }
...
//        }
//
//        telemetryM.addData("Driving forward?: " , forward);
//        telemetryM.addData("Zero Line", 0);
...
//        }
//
//        telemetryM.addData("Driving away from the origin along the curve?: " , forward);
//        telemetryM.update();
//    }
//}
//
