...
public class Shooter {
    ...
    //---------------------------------------------- TUNNEL
    public void openTunnel() { cover.setPosition(POS_COVER_OPEN); }
    public void closeTunnel() { cover.setPosition(POS_COVER_CLOSE); }

    public boolean ifNotInLaunchZoneGoal() { currentPose = follower.getPose();
        return follower.getPose().getY() <= Math.abs(follower.getPose().getX() - 72) + 61;
    }
    public boolean ifNotInLaunchZoneHuman() { currentPose = follower.getPose();
    ...
    public double getVelocityRPS() { return shooterUpper.getVelocity() / TPR; }
    public double getVelocityTPS() { return shooterUpper.getVelocity(); }
