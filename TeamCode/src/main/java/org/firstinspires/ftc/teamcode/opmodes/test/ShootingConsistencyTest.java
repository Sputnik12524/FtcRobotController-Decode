...
public class ShootingConsistencyTest extends LinearOpMode {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(80, 0, 23, 23);
    ...
    public static double ANGULAR_VELOCITY = 1;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStopRequested()) {
            ...
            myMotor.setVelocity(ANGULAR_VELOCITY*360, AngleUnit.DEGREES);
